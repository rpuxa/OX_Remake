...
public class Position {
    ...
    private Position(BitBoard bitBoard, boolean human_plays_for_white, int end_game, ArrayList<Ball> balls, boolean isTurnWhite) {
    ...
    public static Position make_position_empty(boolean human_plays_for_white, boolean isTurnWhite) {
        return new Position(BitBoard.make_bitboard_empty(),human_plays_for_white,0,new ArrayList<>(),isTurnWhite);
    }

    public static Position make_position_from_position(Position position){
        return new Position(BitBoard.make_bitboard_from_bitboard(position.bitBoard),position.human_plays_for_white,position.end_game,new ArrayList<>(position.balls),position.isTurnWhite);
    }
