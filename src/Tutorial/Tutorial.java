...
public class Tutorial implements Runnable {
    ...
    private static final String COMPLETE = "Задача решена!";
    ...
    public void run() {
        ...
        try {
            ...
            new Stage(COMPLETE
                    , 1, 0b1_00000000_00000001_00000000_00000001L, 0b1110);
            new Stage(COMPLETE
